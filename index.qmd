...
2.  Spatial geometry and hydrologic references
3.  
4.  
...
-   "I am the same thing as [Geoconnex Reference Gage 1018463](https://geoconnex.us/ref/gages/1018463)"[^10]
...
[^10]: Where possible, it will useful to tag your organization's locations with pre-existing identifiers for reference locations, since many organizations collect data at the same location.
...
-   "I am on the [Rio Brazos](https://geoconnex.us/ref/mainstems/1611418)"[^11]

[^11]: Note that ideally this would be a geoconnex URI for a river mainstem, in this case <https://geoconnex.us/ref/mainstems/1611418>
...
::: {.callout-note}
Groundwater sample and monitoring locations such as wells can be referenced to aquifer identifiers where available using this pattern:
...
## Complete Examples {#sec-completeExamples}
