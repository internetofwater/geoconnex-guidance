...
``` json
{
 "subjectOf":{                                                                                                // <1>
  ...
  "variableMeasured": {                                                                                       // <4>
   ...
   "measurementTechnique": "location-based observation",                                                      // <10>
   ...
   "distribution": [                                                                                          // <14>
     {
      "@type": "DataDownload",
      "name": "USGS Instantaneous Values Service" // <14>
      "contentUrl": "https://waterservices.usgs.gov/nwis/iv/?sites=08282300&parameterCd=00060&format=rdb",    // <14>
      "encodingFormat": ["text/tab-separated-values"],                                                        // <14>
      "dc:conformsTo": "https://pubs.usgs.gov/of/2003/ofr03123/6.4rdb_format.pdf"                                     // <14>
      },
      {
      "@type": "DataDownload",  
      "name": "USGS SensorThings API"// <15>
      "contentUrl": "https://labs.waterdata.usgs.gov/sta/v1.1/Datastreams('0adb31f7852e4e1c9a778a85076ac0cf')?$expand=Thing,Observations", // <15>
      "encodingFormat": ["application/json"],                                                                 // <15>
      "dc:conformsTo": "https://labs.waterdata.usgs.gov/docs/sensorthings/index.html"                                              // <15>
      }
    ]
  }
}
...
## Complete Examples {#sec-loc-complete-example}
...
+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| gridded model              | This term is meant to group data generating procedures that generate gridded data that is extensive over an area that are meant to represent hypothetical states as detailed above. Examples include flood risk maps and gridded precipitation forecasts.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
+----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
